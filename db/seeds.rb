...
DriverRecord.create!(first_names: 'Bob', last_name: 'Jones', date_of_birth: Date.new(2001, 8, 4), driving_licence_number: 'JONE0804BOBD', driving_licence_type: 'Full')
...
DriverRecord.create!(first_names: 'Tench', last_name: 'Casey', date_of_birth: Date.new(1995, 05, 07), driving_licence_number: 'CASE0507TEAA', driving_licence_type: 'Full')
DriverRecord.create!(first_names: 'Lilly', last_name: 'Lee', date_of_birth: Date.new(1987, 12, 31), driving_licence_type: 'Full')
DriverRecord.create!(first_names: 'Helen', last_name: 'Morris', date_of_birth: Date.new(2000, 2, 29), driving_licence_number: 'MORR0229HEOW', driving_licence_type: 'Full')
